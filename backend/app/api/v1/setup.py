...
#     return {"status": "ok", "webhook_url": url, "telegram_response": result}


# async def auto_register_telegram_webhook():
#     """Best-effort webhook registration on startup."""
...
#         bot = get_telegram_bot()
#         result = await bot.set_webhook(url)
#         logger.info(f"Auto-registered Telegram webhook: {url} -> {result}")
#     except Exception as exc:
#         logger.warning(f"Failed to auto-register Telegram webhook: {exc}")
